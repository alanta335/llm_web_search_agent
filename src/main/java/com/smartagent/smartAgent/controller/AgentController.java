...
/**
 * REST Controller for handling web search queries using the WebSearchAgent.
 * <p>
 * This controller exposes endpoints to interact with the WebSearchAgent, allowing
...
public class AgentController {
     ...
     * WebSearchAgent, and returns a response containing web search results.
     * </p>
     *
